...
const PopUp = ({setOpenModel, donate , donateFunction, getDonations}) => {
    ...
    const createDonation = async () => {
        ...
        return ( 
        <>
            <div className="justify-center items-center flex oveflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                    <div className="border-0 rounded-lg shadow-lg realative flex flex-col w-full bg-white outline-none focus:outline-none">
                        <div className=" flex items-start justify-betweeen p-5 border-b border-solid border-slate-200 rounded-t ">
                        ...
                        <div className="relative p-6 flex-auto">
                            ...
                            required
                            type="text"
                            className="flex-grow w-full h-12 px-4 mb-2 ransition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
                            id="firstName"
                            name="firstName"
                            />
                            {allDonationData && PupUp.map((donate,i) => (
                               <p className="my-4 text-slate-500 text-lg leading-relaxed">
                                {i+1} : {donate.donation} {""}
