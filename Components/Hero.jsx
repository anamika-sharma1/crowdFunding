          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                Sed up prespiciatil unde onmis is tnaute error sit columpatepe
                dfhaoh dhf idni odfdhnda kdjhfiw ,eroedkafadug hkdfha ifhda
              </p>
              <a
                href="/"
                aria-label=""
                className="inline-flex items-centre font-semibold tracking-wider transition-colors duration-200 text-teal-accent-400 hover:text-teal-accent-700 text-gray-200"
              >
                Learn More
                <svg
            ...
            <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
              <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                <h3 className="mb-4 text-xl font-semihold sm:text-center sm:mb-6 sm:text-2xl">
                  Campaign
                </h3>
                <form>
                  ...
                  <div className="mt-4 mb-2 sm:mb-4">
                    <button
                      ...
                      type="submit"
                      className="inline-flex items-center justify-centre w-full h-12
